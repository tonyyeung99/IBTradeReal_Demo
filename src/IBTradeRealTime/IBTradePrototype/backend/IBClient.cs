...
namespace IBTradeRealTime.backend
{
    public class IBClient : EWrapper
    {
        private EClientSocket clientSocket;
        private int nextOrderId;
        private IBTradeApp parentUI;
        ...
        public int IncreaseOrderId()
        {
            int newOrderId = 0;
            newOrderId = Interlocked.Increment(ref nextOrderId);
            return newOrderId;
        }
        ...
        public virtual void connectionClosed()
        {
            ...
            //parentUI.HandleMessage("OFF");
        }

        public virtual void currentTime(long time)
        {
            parentUI.HandleMessage(new ServerTimeMessage(time));
